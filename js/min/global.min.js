...
Gumby.ready(function(){Gumby.log("Gumby is ready to go...",Gumby.dump()),(Gumby.isOldie||Gumby.$dom.find("html").hasClass("ie9"))&&$("input, textarea").placeholder()}).oldie(function(){Gumby.warn("This is an oldie browser...")}).touch(function(){Gumby.log("This is a touch enabled device...")});var ScrollAnimations=function(){if(!Modernizr.touch){var i;return{settings:{$scrollElements:$(".animate-on-scroll"),initClass:"scroll-animation-init",dataAnimation:"scrollanimation"},init:function(){i=this.settings,i.$scrollElements.addClass(i.initClass),this.bindUIActions()},bindUIActions:function(){i.$scrollElements.waypoint(function(n){switch(n){case"down":ScrollAnimations.doDownAnim($(this),$(this).data(i.dataAnimation))}},{offset:"75%"})},doDownAnim:function(i,n){i.addClass(n)}}}}();$(function(){$("#skip-switch").on("gumby.onComplete",function(){$(this).trigger("gumby.trigger")}),$(".signup-form").validation({required:[{name:"email",validate:function(i){return null!==i.val().match("@")}}],fail:function(){Gumby.error("Form validation failed"),$(".catch-errors").addClass("danger alert").html("Please enter a valid email address!")},submit:function(){}}),ScrollAnimations.init(),$(".gallery-slider").bxSlider({pager:!1,nextText:'<i class="icon-right-open-big"></i><span class="screen-reader-text">Next</span>',prevText:'<i class="icon-left-open-big"></i><span class="screen-reader-text">Prev</span>'}),$(".testimonials-slider").bxSlider({auto:!0,pause:6e3,controls:!1,mode:"fade"})});